 ...
 *  it receives after changing to uppercase. It is an on-demand 
 *  concurrent server with clients handled by separate child processes.
 *  Usage:
 ...
 * to the same socket after changing them to uppercase
